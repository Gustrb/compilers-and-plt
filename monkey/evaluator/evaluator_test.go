...
import (
	...
	"github.com/gustrb/compilers-and-plt/monkey/object"
	"github.com/gustrb/compilers-and-plt/monkey/parser"
)
...
func TestFunctionObject(t *testing.T) {
	...
	if fn.Body.String() != expectedBody {
		t.Fatalf("function has wrong body. got=%q, expected=%q", fn.Body.String(), expectedBody)
		return
	}
}
...
func TestArrayLiterals(t *testing.T) {
	...
	if len(array.Elements) != 3 {
		t.Fatalf("array has wrong number of elements. got=%d, expected=3", len(array.Elements))
		return
	}
...
func TestHashLiterals(t *testing.T) {
	...
	if len(hash.Pairs) != len(expected) {
		t.Fatalf("hash has wrong number of pairs. got=%d, expected=%d", len(hash.Pairs), len(expected))
		return
	}
